...
class SetCriterion(nn.Module):
    ...
    def get_loss(self, loss, outputs, targets, indices, num_boxes, **kwargs):
        ...
        for batch_iter_idxs, batch_targets, batch_indices in batch_iterator(
            ...
            batch_loss_dict = loss_map[loss](
                batch_outputs, batch_targets, batch_indices, 1, **kwargs
            )  # num_boxes=1
    ...
    def forward(self, outputs, targets, **kwargs):
        ...
        if "batch_len" not in kwargs:
            ...
            for batch_iter_idxs, batch_targets in batch_iterator(
                ...
                batch_outputs_without_aux = tensor_dict_index_select(
                    outputs_without_aux, batch_iter_idxs, dim=0
                )
